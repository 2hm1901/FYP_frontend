...
export default function AddVenueForm({ userId, onSave, onCancel }) {
  const {
    formData,
    errors,
    allTimeOptions,
  ...
  } = useVenueForm(userId, onSave, onCancel);

  return (
    <div className="bg-white shadow-md rounded-lg p-6">
      <h2 className="text-xl font-semibold text-gray-800 mb-4">Thêm sân mới</h2>
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          />
          {errors.court_count && (
            <p className="text-red-500 text-xs mt-1">{errors.court_count}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.close_time && (
            <p className="text-red-500 text-xs mt-1">{errors.close_time}</p>
          )}
        </div>
        ...
        <div className="col-span-1 sm:col-span-2">
          ...
          {errors.price_slots && (
            <p className="text-red-500 text-xs mt-1">{errors.price_slots}</p>
          )}
